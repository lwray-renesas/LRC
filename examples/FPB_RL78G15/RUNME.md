...
### ✅ Hardware
- Evaluation PCB: `FPB-RL78/G15` (For more information e.g., User Manual/Availability/Documentation please contact your local Renesas Sales/FAE)
- Microcontroller: `RL78/G15 - R5F12068ASP`
- Debugger/Programmer: `COM Port`
...
## 📁 Project Structure
```
├── LRC_FPB_RL78G15/          # e2 studio project
